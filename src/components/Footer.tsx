      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-8 border-b border-gray-800">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              A decentralized ad integrity engine powered by UpRock's DePIN network.
            </p>
            <div className="flex space-x-4">
              ...
              <a href="https://github.com/RachitSrivastava12/Ad-Verify" className="text-gray-400 hover:text-white transition-colors duration-200">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#technology" className="text-gray-400 hover:text-white transition-colors duration-200">
                  Technology
                </a>
              </li>
              <li>
        ...
        <div className="pt-8 text-center">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} DeViewAI. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
